                ...
                @foreach ($articles as $article)
                    <tr>
                        ...
                        <td class="d-flex flex-column flex-md-row">
                            <a href="{{route('article.show', $article)}}" class="btn btn-secondary mb-2 mb-md-0 me-md-2">Leggi</a>
                            <a href="{{route('article.edit', $article)}}" class="btn btn-warning text-white mb-2 mb-md-0 me-md-2">Modifica</a>
